...
public class Car: MonoBehaviour
{
    ...
    public void Update()
    {
        ...
        if (Vector3.Distance(transform.position, nearestPoint) > aheadAmount + 10f)
        {
    ...
    private void FixedUpdate()
    {
        ...
        rb.AddForce(Vector3.down * downforce * Vector3.Dot(transform.forward, rb.linearVelocity), ForceMode.Force);
    }
